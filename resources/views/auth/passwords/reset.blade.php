<?php
$d = "../system/public/AdminLTE/dist/img/fondo1.jpg";
?>
@extends('../layouts.app')
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card justify-content-center" style="margin-top: 50px;opacity: 0.9;background-color: #d4d5d9;">
                <div class="card-header"><img src="/dist/img/AdminLTELogo.png')}}" class="img-circle img-size-32 mr-2" style="opacity: .8; height:55px;width: 60px;">{{ __('Resetea Password') }}</div>
